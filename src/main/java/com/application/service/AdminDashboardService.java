...
//   
//    /**
//     * Calculate Available count based on AdminApp amounts and BalanceTrack distribution.
//     * Logic:
//     * 1. Get all distinct amounts from AdminApp for employee and year (is_active = 1)
//     * 2. For each amount:
//     *    - If amount is distributed in BalanceTrack: use BalanceTrack.appAvblCnt
//     *    - If amount is NOT distributed (0 or doesn't exist): use AdminApp.totalApp
//     * 3. Sum all to get total Available
//     *
        ...
        for (Distribution dist : distributions) {
            ...
            for (AppStatusTrackView app : applications) {
                ...
                switch (statusType.toLowerCase()) {
                    case "sold":
                        // Sold = ONLY "not confirmed" status (not any other status)
